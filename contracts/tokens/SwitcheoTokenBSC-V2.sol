...
*/
contract SwitcheoTokenBSCV2 is ERC20, ERC20Detailed, Ownable {
  using SafeMath for uint256;

  address public lockProxyAddress;
  address public legacyAddress = address(0);

  constructor(address _lockProxyAddress, address _legacyAddress) ERC20Detailed("Switcheo Token", "SWTH", 8) public {
